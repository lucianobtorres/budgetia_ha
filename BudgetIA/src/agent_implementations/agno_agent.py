    ...
    def __init__(
        ...
        if active_provider == "groq":
            try:
                ...
                model_id = (
                    self.llm_orchestrator.active_model_name or "openai/gpt-oss-120b"
                    # self.llm_orchestrator.active_model_name or "llama-3.1-8b-instant"
                )
                # model_id = self.llm_orchestrator.active_model_name or "llama-3.3-70b-versatile"
                ...
                self.model = Gemini(id="gemini-2.5-flash")
        else:
            # Default: Gemini
