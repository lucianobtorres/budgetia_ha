...
from application.notifications.models.push_subscription import (  # noqa: E402
    PushSubscription,  # noqa: E402
)
from application.services.push_notification_service import (  # noqa: E402
    PushNotificationService,  # noqa: E402
)
from interfaces.api.dependencies import get_push_notification_service  # noqa: E402
...
def subscribe_push(
    ...
    user_config: Any = Depends(
        get_notification_service
    ),  # Just to hack getting user_id if needed, but push_service handles it
) -> dict[str, str]:
...
def test_push(
    ...
    count = service.send_notification(
        user_id, "Testando Push Notification! 🚀", "BudgetIA"
    )
