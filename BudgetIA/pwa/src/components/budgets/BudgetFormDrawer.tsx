            ...
            <form id="budget-form" onSubmit={handleSubmit} className="space-y-5 pb-safe pt-2 relative">
                {isLoading && (
                    <div className="absolute inset-0 z-50 bg-surface-card/60 backdrop-blur-[2px] flex items-center justify-center rounded-xl transition-all duration-300">
                        <div className="flex flex-col items-center gap-3">
                             ...
                             <span className="text-xs font-medium text-primary-light animate-pulse">Salvando...</span>
                        </div>
                    </div>
                )}
                ...
                <div>
                    ...
                    <select 
                        ...
                        className="w-full bg-surface-input border border-border text-text-primary rounded-xl px-4 py-3 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors appearance-none"
                    >
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        className="w-full bg-surface-input border border-border text-text-primary rounded-xl px-4 py-3 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
                    />
                </div>
            </form>
        </Drawer>
