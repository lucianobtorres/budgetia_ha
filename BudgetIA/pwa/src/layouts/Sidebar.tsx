...
export function Sidebar() {
  ...
  return (
    <div className="hidden md:flex h-screen w-auto min-w-[16rem] flex-col bg-surface-card text-text-primary border-r border-border transition-all duration-300">
      <div className="flex h-16 items-center px-6 gap-3 border-b border-border">
        <div className="relative h-10 w-10 overflow-hidden rounded-xl shadow-black/50 shadow-md ring-1 ring-white/20 shrink-0 group">
